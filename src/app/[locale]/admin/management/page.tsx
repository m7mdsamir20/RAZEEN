...
import { getAdminManagementRequests } from "@/lib/queries/admin";
import { ManagementActions } from "@/components/admin/ModerationActions";
import { StatusFilter } from "@/components/admin/StatusFilter";

const STATUS_OPTIONS = [
  { value: "NEW", labelKey: "admin.managementStatus.NEW" },
  { value: "CONTACTED", labelKey: "admin.managementStatus.CONTACTED" },
  { value: "CLOSED", labelKey: "admin.managementStatus.CLOSED" },
] as const;
...
export async function generateMetadata({
  ...
  return {
    title: `${t("admin.nav.management")} — ${t("common.appName")}`,
...
export default async function AdminManagementPage({
  ...
  const [t, requests] = await Promise.all([
    ...
    getAdminManagementRequests(statusParam),
  ]);
            ...
            >
              <div className="p-4">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  >
                    {t(`admin.managementStatus.${request.status}`)}
                  </span>
                ...
                <dl className="space-y-1.5 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <dd className="text-gray-700">{request.propertyType}</dd>
                  </div>
              ...
              <div className="px-4 py-3 border-t border-gray-100 bg-gray-50/50">
                <ManagementActions id={request.id} status={request.status} />
              </div>
            </li>
          ))}
        </ul>
